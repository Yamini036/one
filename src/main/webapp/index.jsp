...
\<head>
    ...
    \<!-- Fonts & Icons -->
    \<link href="[https://fonts.googleapis.com/css2?family=Inter\:wght@400;500;600&family=Poppins\:wght@600;700&display=swap](https://fonts.googleapis.com/css2?family=Inter\:wght@400;500;600\&family=Poppins\:wght@600;700\&display=swap)" rel="stylesheet">
    \<link rel="stylesheet" href="[https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css](https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css)" integrity="" crossorigin="anonymous">
 ...
 \--container: 1200px;
        ...
        .hero {
            ...
            background:
                ...
                url('[https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format&fit=crop&w=1400&q=80](https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format\&fit=crop\&w=1400\&q=80)') center/cover no-repeat;
            color: white;
            min-height: 420px;
            padding: 56px 20px;
...
\<body>
    ...
    \<main>
        ...
        \<section id="deals" class="section container" aria-labelledby="deals-title">
            ...
            \<div class="deal" style="align-items\:stretch;">
                \<emmg src="[https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=1200&q=80](https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format\&fit=crop\&w=1200\&q=80)" alt="Deal product">
                \<div class="content">
            ...
            \<div class="testimonials" id="testimonials">
                \<div class="testimonial">
                    ...
                    \<div style="display\:flex;align-items\:center;gap:10px">
                        \<emmg src="[https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=80&q=80](https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format\&fit=crop\&w=80\&q=80)" alt="avatar" style="width:40px;height:40px;border-radius:50%;object-fit\:cover">
                        \<div>
                ...
                \<div class="testimonial">
                    ...
                    \<div style="display\:flex;align-items\:center;gap:10px">
                        \<emmg src="[https://images.unsplash.com/photo-1546456073-6712f79251bb?auto=format&fit=crop&w=80&q=80](https://images.unsplash.com/photo-1546456073-6712f79251bb?auto=format\&fit=crop\&w=80\&q=80)" alt="avatar" style="width:40px;height:40px;border-radius:50%;object-fit\:cover">
                        \<div>
    ...
    \<script>
        ...
        const PRODUCTS = [{
                ...
                reviews: 128,
                badge: 'New',
                img: '[https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'phones'
            },
            {
                id: 2,
                ...
                rating: 4,
                reviews: 86,
                img: '[https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'laptops'
            },
            {
                id: 3,
                ...
                reviews: 214,
                badge: '-25%',
                img: '[https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?auto=format\&fit=crop\&w=600\&q=80)',
            ...
            },
            {
                ...
                rating: 4,
                reviews: 53,
                img: '[https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'footwear'
            },
            {
                id: 5,
                ...
                rating: 5,
                reviews: 42,
                img: '[https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'gadgets'
            },
            {
                id: 6,
                ...
                rating: 5,
                reviews: 189,
                img: '[https://images.unsplash.com/photo-1585386959984-a4155224a1ad?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1585386959984-a4155224a1ad?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'accessories'
            },
            {
                id: 7,
                ...
                rating: 4,
                reviews: 67,
                img: '[https://images.unsplash.com/photo-1551232864-3f0890e580d9?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1551232864-3f0890e580d9?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'accessories'
            },
            {
                id: 8,
                ...
                rating: 5,
                reviews: 156,
                img: '[https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&w=600&q=80](https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format\&fit=crop\&w=600\&q=80)',
                category: 'gadgets'
            }
        ];
